...
public class DetailPlant {
    ...
    // Constructeur
    public DetailPlant(boolean isPlant, boolean nuisible, List<GeoPoint> naturaliseeZone, String categorie, String toxicity, boolean ismauvaiseHerbe, boolean isenvahissant, String scientificName, String dureedeVie, String periodedeplantation, String descriptionfr,
